About orange3-survival-analysis
===============================
...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/orange3-survival-analysis-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13958&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/orange3-survival-analysis-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `orange3-survival-analysis` can be installed with:

```
conda install orange3-survival-analysis
```

It is possible to list all of the versions of `orange3-survival-analysis` available on your platform with:
